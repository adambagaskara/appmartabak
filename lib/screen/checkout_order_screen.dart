          ...
          children: [
            Padding(
              padding: const EdgeInsets.only(
                  bottom: 20, left: 10, right: 10, top: 25),
              child: Text(
            ...
            Padding(
              padding: const EdgeInsets.only(
                  bottom: 10, left: 30, right: 0, top: 30),
              child: Row(children: [
            ...
            Padding(
              padding: const EdgeInsets.only(
                  bottom: 10, left: 30, right: 0, top: 10),
              child: Row(children: [
            ...
            Padding(
              padding: const EdgeInsets.only(
                  bottom: 40, left: 30, right: 0, top: 10),
              child: Row(children: [
                Text(
                    style: GoogleFonts.overpassMono(),
                    'Jumlah Martabak Teri: '),
            ...
            Padding(
              padding: const EdgeInsets.only(
                  bottom: 30, left: 30, right: 0, top: 10),
              child: Row(children: [
